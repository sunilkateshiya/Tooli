...
//  TooliDemo
//
//  Created by Azharhussain on 16/08/17.
...
class OtherContractorProfile: UIViewController, UITableViewDataSource, UITableViewDelegate,UIScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource, NVActivityIndicatorViewable,SKPhotoBrowserDelegate
{
     //--------------------------------------
     ...
     @IBOutlet weak var AbooutusHeight: NSLayoutConstraint!
    ...
    @IBOutlet weak var BtnFollowUnfollow1: UIButton!
    ...
    @IBAction func homePage(_ sender: UIButton)
    {
     ...
     func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
     {
          ...
          {
                return OtherContactorProfileVview.Result.ActivityList.count
          }
          else
          {
               return 0
          ...
          else if tableView == TblActivity
          {
            ...
            else if(self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PageType == 3)
            {
                ...
                else
                {
                    ...
                    cell.likeHeight.constant = 0
                    cell.lblTitle.text = self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PortfolioView.CompanyName + " - " + self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PortfolioView.TradeName
                    cell.lblDate.text = self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PortfolioView.TitleCaption + "\n" + self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PortfolioView.Location + self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PortfolioView.TimeCaption
                    cell.lblDis.text = self.OtherContactorProfileVview.Result.ActivityList[indexPath.row].PortfolioView.Description
     ...
     {
          return self.OtherContactorProfileVview.Result.PortfolioList.count
     }
     ...
     func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
     {
        ...
        if(OtherContactorProfileVview.Result.PortfolioList[indexPath.item].PortfolioImageList.count > 0)
        {
          ...
          Collectcell.lblTitle.text = self.OtherContactorProfileVview.Result.PortfolioList[indexPath.item].Title
          return Collectcell
     }
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "PortfolioDetails") as! PortfolioDetails
        vc.portfolio = self.OtherContactorProfileVview.Result.PortfolioList[indexPath.row]
     ...
     // MARK: - Button Save
     //--------------------------------------
     @IBAction func BtnSaveStarTapped(_ sender: UIButton)
     {
     ...
     @IBAction func BtnFollowersTapped(_ sender: UIButton)
     {
        ...
        if(self.OtherContactorProfileVview.Result.FollowerUserList.count == 0)
        {
     ...
     @IBAction func BtnFollowingTapped(_ sender: UIButton)
     {
        ...
        if(self.OtherContactorProfileVview.Result.FollowingUserList.count == 0)
        {
            self.nodataView.isHidden = false
        }
        else
     ...
     @IBAction func BtnBackToTimelineTapped(_ sender: Any)
     {
          ...
          self.AboutUsView.isHidden = true
          self.AbooutusHeight.constant = TblActivity.contentSize.height
     ...
     @IBAction func BtnFollowingFromHeaderTapped(_ sender: Any)
     {
          ...
          self.AbooutusHeight.constant = self.TblFollowers.contentSize.height
     ...
     //--------------------------------------
     // MARK: - Button User Follow Unfollow
     //--------------------------------------
     @IBAction func BtnUserFollowUnfollowTapped(_ sender: UIButton)
     {
        self.startAnimating()
        ...
        AFWrapper.requestPOSTURL(Constants.URLS.AccountFollowToggle, params :param as [String : AnyObject]? ,headers : nil  ,  success: {
            ...
            {
                if self.BtnFollowUnfollow.titleLabel!.text == "FOLLOW"
                {
                    self.BtnFollowUnfollow.setTitle("FOLLOWING", for: .normal)
                    self.BtnFollowUnfollow.backgroundColor = UIColor(red: 192.0/255.0, green: 129.0/255.0, blue: 1/255.0, alpha: 1)
                    
                    self.BtnFollowUnfollow1.setTitle("FOLLOWING", for: .normal)
                    self.BtnFollowUnfollow1.backgroundColor = UIColor(red: 192.0/255.0, green: 129.0/255.0, blue: 1/255.0, alpha: 1)
                }
                else
                {
                    self.BtnFollowUnfollow.setTitle("FOLLOW", for: .normal)
                    self.BtnFollowUnfollow.backgroundColor = UIColor(red: 236.0/255.0, green: 169.0/255.0, blue: 8.0/255.0, alpha: 1)
                    
                    self.BtnFollowUnfollow1.setTitle("FOLLOW", for: .normal)
                    self.BtnFollowUnfollow1.backgroundColor = UIColor(red: 236.0/255.0, green: 169.0/255.0, blue: 8.0/255.0, alpha: 1)
                }
     ...
     @IBAction func BtnMessageTapped(_ sender: UIButton)
     {
        ...
        currentBuddy.Name = self.OtherContactorProfileVview.Result.FullName
        currentBuddy.IsReadLastMessage = true
        currentBuddy.Role = 1
        currentBuddy.ProfileImageLink = self.OtherContactorProfileVview.Result.ProfileImageLink
     ...
     @IBAction func BtnAboutTapped(_ sender: UIButton)
     {
          ...
          self.AbooutusHeight.constant = 2000
     ...
     @IBAction func BtnRecentWorkTapped(_ sender: UIButton)
     {
          ...
          self.AbooutusHeight.constant = self.ClcRecentWork.contentSize.height
          setLayout()
        
        if(self.OtherContactorProfileVview.Result.PortfolioList.count == 0)
        {
            self.nodataView.isHidden = false
        }
        else
    ...
    @IBAction func btnMyJobAction(_ sender: UIButton)
    {
        ...
        vc.username = self.OtherContactorProfileVview.Result.FullName
        self.navigationController?.pushViewController(vc, animated: true)
    }
    ...
    func SetRateTravalData()
    {
     ...
     func ProfileData()
     {
          ...
          if self.OtherContactorProfileVview.Result.IsSaved
          {
        ...
        if self.OtherContactorProfileVview.Result.IsFollow
        {
            self.BtnFollowUnfollow.setTitle("FOLLOWING", for: .normal)
            self.BtnFollowUnfollow.backgroundColor = UIColor(red: 192.0/255.0, green: 129.0/255.0, blue: 1/255.0, alpha: 1)
        ...
        else
        {
          ...
          if self.OtherContactorProfileVview.Result.IsFollowing
          {
                self.BtnMessage.isHidden = false
                self.BtnFollowUnfollow1.isHidden = true
                self.BtnFollowUnfollow.isHidden = false
          }
          else
          {
                self.BtnMessage.isHidden = true
                self.BtnFollowUnfollow1.isHidden = false
