...
class EditExperience:UIViewController,UITableViewDelegate, UITableViewDataSource ,NVActivityIndicatorViewable {
     ...
     @IBAction func actionSubmit(sender : UIButton){
          ...
          for index in 0 ..< self.sharedManager.currentUser.ExperienceList!.count {
